export default {
  ...
  'session.action.recover': 'Recover Session',
  ...
  'newSession.codexTransport': 'Codex transport',
  'newSession.codexTransport.auto': 'Auto (machine default)',
  'newSession.codexTransport.appServer': 'App Server',
  'newSession.codexTransport.sdk': 'SDK',
  'newSession.codexTransport.mcp': 'MCP Server',
  ...
  'machine.more': 'More actions',
  'machine.action.updateHapi': 'Update HAPI',
  'machine.action.updateCodex': 'Update Codex',
  'machine.action.updateClaude': 'Update Claude',
  'machine.update.title': 'Update {tool}',
  'machine.update.description': 'This will run the {tool} update command on “{machine}”. It may take a few minutes and may restart the runner. Continue?',
  'machine.update.confirm': 'Update',
  'machine.update.confirming': 'Updating…',
  'machine.update.success': '{tool} update completed',
  'machine.update.failed': '{tool} update failed',
  'machine.updateOnlineOnly': 'Machine must be online to update.',
  'machine.save': 'Save',
