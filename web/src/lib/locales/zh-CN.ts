export default {
  ...
  'newSession.codexTransport': 'Codex 传输模式',
  'newSession.codexTransport.auto': '自动（机器默认）',
  ...
  'machine.more': '更多操作',
  'machine.action.updateHapi': '更新 HAPI',
  'machine.action.updateCodex': '更新 Codex',
  'machine.action.updateClaude': '更新 Claude',
  'machine.update.title': '更新 {tool}',
  'machine.update.description': '将在机器“{machine}”上执行 {tool} 更新命令。可能需要几分钟，并可能重启 runner。确定继续？',
  'machine.update.confirm': '更新',
  'machine.update.confirming': '更新中…',
  'machine.update.success': '{tool} 更新完成',
  'machine.update.failed': '{tool} 更新失败',
  'machine.updateOnlineOnly': '机器需在线才能更新',
  'machine.save': '保存',
  'machine.cancel': '取消',
