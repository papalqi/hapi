...
export function MachineActionMenu(props: MachineActionMenuProps) {
    ...
    const resolvedMenuId = menuId ?? `machine-action-menu-${internalId}`
    const headingId = `${resolvedMenuId}-heading`

    const handleUpdateHapi = () => {
        onClose()
        onUpdateHapi()
    }
        ...
        >
            ...
            >
                <button
                    ...
                    onClick={handleUpdateHapi}
                >
                    <RefreshIcon className="text-[var(--app-hint)]" />
                    {t('machine.action.updateHapi')}
                </button>
                <button
                    type="button"
                    role="menuitem"
